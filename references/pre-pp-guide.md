...
- **数据集**：[2025春季创业营57个项目2分钟路演视频 Whisper 转录文本](https://github.com/qbu11/2025s-accelerator-pitch-transcripts)
- **分析样本**：13 个代表性项目（涵盖 AI、硬件、SaaS、消费、生物医药等多个领域）
- **提取规则**：第一页定位、前三页记忆测试、吸睛度钩子、虚实叙事节奏

### 加速器 Pitch Practice 方法论
...
MIT © accelerator CC Team

## 相关链接

- [加速器官网](https://www.accelerator.com/)
- [lark-cli 文档](https://github.com/larksuite/cli)
- [Claude Code 文档](https://claude.ai/code)

---

**Built with ❤️ by accelerator CC Team**
